...
import { Array, Chunk, Duration, Effect, Layer, type NonEmptyReadonlyArray, Option, pipe, Redacted, S, Struct } from "effect-app"
import { toNonEmptyArray } from "effect-app/Array"
import { StringId } from "effect-app/Schema"
import { dropUndefinedT } from "effect-app/utils"
import { CosmosClientLayer } from "../adapters/cosmos-client.js"
...
const base = {
  id: SQLModel.Generated(StringId),
  // meta: SQLModel.JsonFromString(QueueMeta),
  data: SQLModel.JsonFromString(S.Unknown),
  etag: S.String // TODO: use a SQLModel thing that auto updates it?
}
class Model extends SQLModel.Class<Model>("Model")({
  ...base
}) {}
      ...
      make: <IdKey extends keyof Encoded, Encoded extends FieldValues, R = never, E = never>(
        ...
        Effect.gen(function*() {
          ...
          /*
                ...
                : undefined
          */
          const container = yield* SQLModel.makeRepository(Model, {
            tableName: containerId,
            spanPrefix: "QueueRepo",
            idColumn: "id",
            versionColumn: "etag"
          })
          container.insertVoid()

          const defaultValues = config?.defaultValues ?? {}
          // const container = db.container(containerId)
          // const bulk = forEach insert
          // const execBatch = forEach insert // but within transaction
