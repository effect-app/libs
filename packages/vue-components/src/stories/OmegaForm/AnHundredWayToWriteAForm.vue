<template>
  <div class="container">
  <h1>An Hundred Way To Write A Form</h1>
  <p>
    OmegaForm is a powerful and flexible form library, that wraps  that allows you to create
    forms in a declarative way. Here are some examples of how to write forms
...
console.log(S, OmegaForm, OmegaInput, useOmegaForm)
</script>
