import { Cause, Duration, Effect, Layer, ParseResult, Request, Schedule, type Schema, Unify } from "effect"
...
export class RequestCacheMiddleware extends MiddlewareNative.RequestCacheMiddleware {
...
export class LoggerMiddleware extends MiddlewareNative.LoggerMiddleware {
  static readonly Default = Layer.effect(
    this,
    Effect.gen(function*() {
